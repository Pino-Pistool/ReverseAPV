...
| | |
|---|---|
| Overheidsorganisatie      | Hoge Raad Reverse |
| Officiële naam            | Algemeen Wetboek Reverse |
| Citeertitel               | Wetboek Reverse |
...
1. Het Wetboek Reverse (verder aangeduid als WTDA) is leidend voor alle beschreven gevallen, waarbij als aanvulling het Nederlands Recht van toepassing is.
2. Het WTDA heeft betrekking op het vaste land, de gemeente, en de stad Reverse.
3. Het WTDA is nauw verweven met de Algemene Plaatselijke Verordening Reverse (APV). De APV dient echter als een indicerend kader voor eventuele bestraffing in-game (“in RP”) en is verder bedoeld voor het afhandelen van straffen buiten de RP om.
...
3. Minderjarigen worden binnen Reverse op dezelfde manier behandeld als volwassenen. Alle bepalingen, straffen en dergelijke zijn ook van toepassing op hen. Minderjarigen hebben dezelfde rechten en plichten als volwassenen. Het jeugdstrafrecht is in Reverse niet van toepassing.
...
3. Geldige redenen voor inbeslagname zijn:
    1. Plegen van een strafbaar feit uit het wetboek van Reverse waarbij het goed direct of indirect betrokken is, met uitzondering van fout parkeren en snelheidsovertredingen zoals beschreven in lid 4;  
...
---------------------
*Wetboek Reverse is opgesteld uit naam van de Hoge Raad, bedoeld voor de gemeente en de stad Reverse, opgetekend door Pino Pistool - pistool.exe, te Reverse.*
